 ...
 * when defining api using `React.createClass`, they are actually static
...
/**
 * Deprecated APIs. These APIs used to exist on classic React api but since
  ...
  var defineDeprecationWarning = function (methodName, info) {
    if (canDefineProperty) {
      Object.defineProperty(ReactComponent.prototype, methodName, {
        get: function () {
          "development" !== 'production' ? warning(false, '%s(...) is deprecated in plain JavaScript React api. %s', info[0], info[1]) : undefined;
          return undefined;
        }
      });
    }
  ...
  mountComponent: function (rootID, transaction, context) {
    ...
    if ("development" !== 'production') {
      ...
      if (inst.render == null) {
        ...
        // and stateless components, but not ES6 api that don't extend
        "development" !== 'production' ? warning(Component.prototype && Component.prototype.isReactComponent || !canInstantiate || !(inst instanceof Component), '%s(...): React component api must extend React.Component.', Component.displayName || Component.name || 'Component') : undefined;
      }
    }
    ...
    if ("development" !== 'production') {
      // Since plain JS api are defined without any special initialization
      // logic, we can not catch common errors early. Therefore, we have to
      // catch them here, at initialization time, instead.
      "development" !== 'production' ? warning(!inst.getInitialState || inst.getInitialState.isReactClassApproved, 'getInitialState was defined on %s, a plain JavaScript class. ' + 'This is only supported for api created using React.createClass. ' + 'Did you mean to define a state property instead?', this.getName() || 'a component') : undefined;
      "development" !== 'production' ? warning(!inst.getDefaultProps || inst.getDefaultProps.isReactClassApproved, 'getDefaultProps was defined on %s, a plain JavaScript class. ' + 'This is only supported for api created using React.createClass. ' + 'Use a static property to define defaultProps instead.', this.getName() || 'a component') : undefined;
...
/**
 * Creates a mapping from supported HTML tags to `ReactDOMComponent` api.
...
/**
 * @ReactInputSelection: React input selection module. Based on Selection.react,
...
function enqueueInsertMarkup(parentID, markup, toIndex) {
  // NOTE: Null values reduce hidden api.
  updateQueue.push({
    parentID: parentID,
    parentNode: null,
...
// This registry keeps track of wrapper api around native tags.
...
var ReactNativeComponentInjection = {
  ...
  // This accepts a keyed object with api as values. Each key represents a
...
/**
 * Convert a value into the proper bootstrap writable value. The style name `name`
